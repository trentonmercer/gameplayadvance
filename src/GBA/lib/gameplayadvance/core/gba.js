function GameBoyAdvance(audio_option) {
	...
	this.SYS_ID = 'com.gameplayadvance.data';
	...
	this.audio = new GameBoyAdvanceAudio(audio_option);
...
GameBoyAdvance.prototype.loadRomFromFile = function(inputFile, callback) {
